codeunit 50100 "CSD Seminar-Post"
{
    ...
    // CSD1.00 2021.03.19 Torben Christensen
    // Chapter 7 - Lab 4-7
    TableNo = 50110;
    ...
    begin
        ...
        if SeminarRegHeader."Posting No." = '' then begin
            ...
            SeminarRegHeader."Posting No." := NoSeriesMgt.GetNextNo(SeminarRegHeader."Posting No. Series",
                                                                    SeminarRegHeader."Posting Date", true);
